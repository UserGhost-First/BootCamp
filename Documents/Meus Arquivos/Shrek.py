...
pyautogui.FAILSAFE = True  # Segurança: mover mouse para o canto superior esquerdo cancela
time.sleep(5)  # Tempo para focar na janela alvo
...
for linha in dialogo.split('\n'):
    if linha.strip():
        pyautogui.hotkey('ctrl', 'k')  # Abre campo de mensagem
        time.sleep(0.3)
        pyautogui.write(linha, interval=0.05)  # Digita
        pyautogui.press('enter')  # Envia
        time.sleep(0.8)  # Intervalo entre falas
